...
<div class="welcome" onclick="noneExpand('e_earth', 'e_layers', 'e_moon', 'e_mars', 'e_keyboard');">
      ...
      <div class="layers">
        ...
        <img onclick="changePlanet('earth'); toggleExpand('e_layers', 'e_earth', 'e_moon', 'e_mars', 'e_keyboard');" src="images/layers.png" />
	...
	<button onclick="reco.toggleStartStop()" style="border: 0; background-color:transparent">
	  <img id="status_img" src="images/mic.gif" alt="Start"></button>
	</div>
      ...
      <div class="keyboard">
        ...
        <img onclick="toggleExpand('e_keyboard', 'e_earth', 'e_mars','e_moon', 'e_layers');" src="images/keyboard.png" />
